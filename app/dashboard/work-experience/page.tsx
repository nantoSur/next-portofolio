        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-100 dark:bg-gray-700">
            <tr>
              ...
              {["company", "role", "start_date"].map((field) => (
                <th
                  key={field}
        ...
        <Dialog open={!!deleting} onOpenChange={() => setDeleting(null)}>
          <DialogContent onInteractOutside={(e) => e.preventDefault()}>
            ...
            <p>
              ...
              <strong>{deleting.company}</strong>?
            </p>
            <DialogFooter>
        ...
        <Dialog open={!!viewing} onOpenChange={() => setViewing(null)}>
          <DialogContent onInteractOutside={(e) => e.preventDefault()}>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                <strong>Role:</strong> {viewing.role}
              </div>
              <div>
              ...
              <div>
                ...
                <ul className="list-disc pl-4">
                  {viewing.summary?.length ? (
                    viewing.summary.map((s, i) => <li key={i}>{s}</li>)
                  ) : (
                    <li>-</li>
                  )}
                </ul>
              ...
              <div>
                ...
                <ul className="list-disc pl-4">
                  {viewing.achievements?.length ? (
                    viewing.achievements.map((a, i) => <li key={i}>{a}</li>)
                  ) : (
                    <li>-</li>
                  )}
                </ul>
